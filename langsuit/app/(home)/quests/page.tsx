  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold text-primary mb-4 tracking-tight">Quests</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {quests && quests.map((quest, index) => {
            ...
            return (
              ...
              >
                <Card className={`h-full transition-all backdrop-blur-md ${
                  isCompleted
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <div className={`p-3 rounded-full mr-4 ${isCompleted ? 'bg-green-400' : 'bg-primary'}`}>
                        {isCompleted ? (
                    ...
                    <p className="text-primary/80 mb-4">{quest.description}</p>
            ...
            <Card className="backdrop-blur-md bg-background/60 py-8 px-6">
              <CardContent>
                ...
                <p className="text-primary/80 mb-6">
                  Begin your adventure, complete quests, and earn amazing rewards!
                </p>
