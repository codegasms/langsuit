		...
		<div className='flex-1 overflow-auto relative z-10'>
			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					...
					<StatCard name='Top Selling' icon={TrendingUp} value={topcourseTitle} color='#10B981' />
					<StatCard name='Lowest Visit' icon={AlertTriangle} value={lowcourse} color='#F59E0B' />
					<StatCard name='Total Revenue' icon={DollarSign} value={"₹"+stats} color='#EF4444' />
				</motion.div>
