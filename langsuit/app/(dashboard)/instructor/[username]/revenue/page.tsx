  ...
  return (
    <div className="space-y-4" style={{ backgroundColor: darkThemeColors.background, minHeight: '100vh', padding: '20px' }}>
      <MotionCard className="w-full" variants={cardVariants} initial="hidden" animate="visible" style={{ backgroundColor: darkThemeColors.cardBackground }}>
        <CardHeader>
          <h2 className="text-2xl font-bold" style={{ color: darkThemeColors.text }}>Revenue Overview</h2>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <MotionCard variants={cardVariants} initial="hidden" animate="visible" style={{ backgroundColor: darkThemeColors.cardBackground }}>
              <CardContent>
                <p className="text-lg font-semibold" style={{ color: darkThemeColors.highlightText }}>Total Revenue</p>
                <p className="text-3xl font-bold" style={{ color: darkThemeColors.text }}>${totalRevenue.toFixed(2)}</p>
              </CardContent>
            </MotionCard>
            <MotionCard variants={cardVariants} initial="hidden" animate="visible" style={{ backgroundColor: darkThemeColors.cardBackground }}>
              <CardContent>
                <p className="text-lg font-semibold" style={{ color: darkThemeColors.highlightText }}>Course Revenue</p>
                <p className="text-3xl font-bold" style={{ color: darkThemeColors.text }}>${courseRevenue.toFixed(2)}</p>
              </CardContent>
            </MotionCard>
            <MotionCard variants={cardVariants} initial="hidden" animate="visible" style={{ backgroundColor: darkThemeColors.cardBackground }}>
              <CardContent>
                <p className="text-lg font-semibold" style={{ color: darkThemeColors.highlightText }}>Stream Revenue</p>
                <p className="text-3xl font-bold" style={{ color: darkThemeColors.text }}>${streamRevenue.toFixed(2)}</p>
              </CardContent>
            </MotionCard>
          </div>
        </CardContent>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={revenueData}>
              ...
              <Area type="monotone" dataKey="total" stroke={darkThemeColors.areaStroke} fill={darkThemeColors.areaFill} />
            </AreaChart>
          </ResponsiveContainer>
        </CardContent>
      </MotionCard>
